...
namespace AU.AppTracker.Mobile.Views {
      ...
      public partial class NetworkUsagePage : ContentPage {
            List<AppProcess> apps = new List<AppProcess>();
            public NetworkUsagePage() {
                  InitializeComponent();
                  LoadData();
            }
            ...
            private void AtLeastButton_Clicked(object sender, System.EventArgs e) {
                  ...
                  lstApps.ItemsSource = apps.OrderBy(x => x.NetworkUsageTotal).ToList();
            }
            ...
            private void AtMostButton_Clicked(object sender, System.EventArgs e) {
                  ...
                  lstApps.ItemsSource = apps.OrderByDescending(x => x.NetworkUsageTotal).ToList();
            }
